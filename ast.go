...
type SQLNode interface {
	...
	WalkSubtree(level int, visit Visit) error
}

// Visit defines the signature of a function that
// can be used to visit all nodes of a parse tree.
type Visit func(level int, node SQLNode) (kontinue bool, err error)

// Walk calls visit on every node.
// If visit returns true, the underlying nodes
// are also visited. If it returns an error, walking
// is interrupted, and the error is returned.
func Walk(level int, visit Visit, nodes ...SQLNode) error {
	for _, node := range nodes {
		if node == nil {
			continue
		}
		kontinue, err := visit(level, node)
		if err != nil {
			return err
		}
		if kontinue {
			err = node.WalkSubtree(level+1, visit)
			if err != nil {
				return err
			}
		}
...
func (node *Select) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *ParenSelect) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *Union) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *Stream) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *Insert) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *Update) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *Delete) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *Set) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *DBDDL) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *DDL) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *PartitionSpec) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	if err := Walk(level,visit, node.Name); err != nil {
		return err
	}
	for _, def := range node.Definitions {
		if err := Walk(level,visit, def); err != nil {
			return err
		}
	}
	return nil
...
func (node *PartitionDefinition) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (ts *TableSpec) WalkSubtree(level int, visit Visit) error {
	if ts == nil {
		return nil
	}

	for _, n := range ts.Columns {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
	}
...
func (col *ColumnDefinition) WalkSubtree(level int, visit Visit) error {
	if col == nil {
		return nil
	}
	return Walk(level,
...
func (ct *ColumnType) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (idx *IndexDefinition) WalkSubtree(level int, visit Visit) error {
	if idx == nil {
		return nil
	}

	for _, n := range idx.Columns {
		if err := Walk(level,visit, n.Column); err != nil {
			return err
		}
	}
...
func (ii *IndexInfo) WalkSubtree(level int, visit Visit) error {
	return Walk(level,visit, ii.Name)
}
...
func (node *VindexSpec) WalkSubtree(level int, visit Visit) error {
	err := Walk(level,visit,
		node.Name,
	)
...
func (node VindexParam) WalkSubtree(level int, visit Visit) error {
	return Walk(level,visit,
		node.Key,
	)
}
...
func (node *Show) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *ShowFilter) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *Use) WalkSubtree(level int, visit Visit) error {
	return Walk(level,visit, node.DBName)
}
...
func (node *Begin) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *Commit) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *Rollback) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *OtherRead) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *OtherAdmin) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node Comments) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node SelectExprs) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node *StarExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *AliasedExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node Nextval) WalkSubtree(level int, visit Visit) error {
	return Walk(level,visit, node.Expr)
}
...
func (node Columns) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node Partitions) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node TableExprs) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node *AliasedTableExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node TableNames) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node TableName) WalkSubtree(level int, visit Visit) error {
	return Walk(level,
		visit,
		node.Name,
		node.Qualifier,
...
func (node *ParenTableExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node JoinCondition) WalkSubtree(level int, visit Visit) error {
	return Walk(level,
		visit,
		node.On,
		node.Using,
...
func (node *JoinTableExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *IndexHints) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	for _, n := range node.Indexes {
...
func (node *Where) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node Exprs) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node *AndExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *OrExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *NotExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *ParenExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *ComparisonExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *RangeCond) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *IsExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *ExistsExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *SQLVal) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *NullVal) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node BoolVal) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *ColName) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node ValTuple) WalkSubtree(level int, visit Visit) error {
	return Walk(level,visit, Exprs(node))
}
...
func (node *Subquery) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node ListArg) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *BinaryExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *UnaryExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *IntervalExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *CollateExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *FuncExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *GroupConcatExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *ValuesFuncExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *SubstrExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *ConvertExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *ConvertUsingExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *ConvertType) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *MatchExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *CaseExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	if err := Walk(level,visit, node.Expr); err != nil {
		return err
	}
	...
	return Walk(level,visit, node.Else)
}
...
func (node *Default) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *When) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node GroupBy) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node OrderBy) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node *Order) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node *Limit) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node Values) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node UpdateExprs) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node *UpdateExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node SetExprs) WalkSubtree(level int, visit Visit) error {
	for _, n := range node {
		if err := Walk(level,visit, n); err != nil {
			return err
		}
...
func (node *SetExpr) WalkSubtree(level int, visit Visit) error {
	if node == nil {
		return nil
	}
	return Walk(level,
...
func (node OnDup) WalkSubtree(level int, visit Visit) error {
	return Walk(level,visit, UpdateExprs(node))
}
...
func (node *ColIdent) GetV() string{
	return node.val
}
func (node *ColIdent) SetV(str string) {
	node.val = str
}
// Format formats the node.
...
func (node ColIdent) WalkSubtree(level int, visit Visit) error {
	return nil
}
...
func (node *TableIdent) SetV(v string) {
	node.v = v
}
func (node *TableIdent) GetV() string {
	return node.v
}
...
func (node TableIdent) WalkSubtree(level int, visit Visit) error {
	return nil
}
